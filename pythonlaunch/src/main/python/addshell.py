...
def init(exedir):
    ...
    game_conf.PETERSHELL = exedir + "/" + game_conf.PETERSHELL
    game_conf.SIGNAPK = exedir+"/"+game_conf.SIGNAPK
    game_conf.SIGNKEY_PK8 = exedir+"/"+game_conf.SIGNKEY_PK8
    game_conf.SIGNKEY_PEM = exedir+"/"+game_conf.SIGNKEY_PEM
